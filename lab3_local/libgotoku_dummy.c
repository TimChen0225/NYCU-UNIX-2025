...
void *game_get_ptr() { return __stored_ptr; }
...
void gop_fill_1() {
  gop_fill(1);
  printf("GOTOKU: fill 1\n");
}
void gop_fill_2() {
  gop_fill(2);
  printf("GOTOKU: fill 2\n");
}
void gop_fill_3() {
  gop_fill(3);
  printf("GOTOKU: fill 3\n");
}
void gop_fill_4() {
  gop_fill(4);
  printf("GOTOKU: fill 4\n");
}
void gop_fill_5() {
  gop_fill(5);
  printf("GOTOKU: fill 5\n");
}
